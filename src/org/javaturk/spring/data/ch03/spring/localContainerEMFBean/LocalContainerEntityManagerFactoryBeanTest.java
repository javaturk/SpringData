package org.javaturk.spring.data.ch03.spring.localContainerEMFBean;
...
import org.javaturk.spring.data.ch03.spring.localContainerEMFBean.conf.*;
import org.springframework.context.annotation.AnnotationConfigApplicationContext;
import org.springframework.context.annotation.Import;

@Import({ AppConfig.class, JPAConfig.class })
public class LocalContainerEntityManagerFactoryBeanTest {
	private static AnnotationConfigApplicationContext context;
	private PersonDao dao;

	public static void main(String[] args) throws NoSuchPersonException {
		context = new AnnotationConfigApplicationContext(LocalContainerEntityManagerFactoryBeanTest.class);
		LocalContainerEntityManagerFactoryBeanTest test = context.getBean(LocalContainerEntityManagerFactoryBeanTest.class);
